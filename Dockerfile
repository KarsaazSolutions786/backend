...
RUN python -m venv /opt/venv && \
    ...
    pip install --no-cache-dir fastapi uvicorn[standard] pydantic sqlalchemy psycopg2-binary aiofiles python-dotenv PyJWT python-jose[cryptography] passlib[bcrypt] firebase-admin httpx python-multipart requests numpy scipy librosa soundfile pydub SpeechRecognition python-dateutil && \
