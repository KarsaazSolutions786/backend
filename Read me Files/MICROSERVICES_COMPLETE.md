...
| **Auth Service**      | 8001 | auth_db      | customer authentication & JWT management  | `/auth/*`          |
| **customer Service**      | 8002 | customer_db      | customer profiles & preferences           | `/customers/*`         |
...
### 2. customer Service (`customers-service`)

**Purpose**: customer profile management and preferences
...
GET  /reminders/           - Get customer reminders (with filters)
...
```
POST /intent/classify      - Classify customer intent
...
```
customer.created        -> customer service notifies other services
reminder.created    -> Reminder created, notify scheduler
reminder.due        -> Scheduler notifies customer service
...
/customers/*        -> customer-service:8002
